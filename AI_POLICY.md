...
Adapted from Open edX’s [AI Policy](https://github.com/openedx/.github/blob/master/AI_POLICY.md), with minor modifications.

This policy applies to contributors of code to resource-superstaq, as
...
platform. Unnecessary code churn,
...
*Review assisted by ChatGPT. I used it to talk through the changes, track my
