...
def test_t_distillery(circuit5: cirq.Circuit) -> None:
    distillery = MovementTDistillery(circuit5, num_t_factories=3)
...
def test_toff_distillery(circuit5: cirq.Circuit) -> None:
    distillery = MovementToffDistillery(circuit5, num_toff_factories=3)
